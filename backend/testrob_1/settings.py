"""
Django settings for testrob_1 project.
...
WSGI_APPLICATION = 'testrob_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testrob_1 API",
    "DESCRIPTION": "API documentation for testrob_1 App",
    "VERSION": "v1",
}
